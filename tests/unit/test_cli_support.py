...
def test_resolve_additional_scoring_reference_paths_returns_expected_reference_families() -> None:
    ...
    assert set(grazing_references) == {"modeler", "gpt5.2_short", "gpt5.2_long"}
    assert grazing_references["modeler"] == Path("data/summaries/modelers/grazing_modeler_ground_truth.txt")
