...
def _build_sample_case_payload(*, run_root: Path, report: dict[str, Any], case_dir: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "paths": {
            ...
            "table_csv": _relative_path(run_root, inputs_dir / "trend_evidence_table.txt"),
            "table_series_csv": _relative_path(run_root, inputs_dir / "trend_evidence_table_series.csv"),
            "table_json": _relative_path(run_root, inputs_dir / "trend_evidence_table.json"),
        ...
        "table_csv_text": _read_optional_text(inputs_dir / "trend_evidence_table.txt"),
        ...
        trend_entries.append(
            {
                ...
                "table_csv_path": _relative_path(run_root, trend_dir / "trend_evidence_table.txt"),
                "table_csv_text": _read_optional_text(trend_dir / "trend_evidence_table.txt"),
                "table_series_csv_path": _relative_path(run_root, trend_dir / "trend_evidence_table_series.csv"),
                "table_json_path": _relative_path(run_root, trend_dir / "trend_evidence_table.json"),
