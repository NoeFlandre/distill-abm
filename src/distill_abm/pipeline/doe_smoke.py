...
from distill_abm.pipeline.run_artifact_contracts import create_run_root, run_log_path, write_latest_run_pointer
...
def run_doe_smoke_suite(
    *,
    ...
    _write_csv(
        ...
        fieldnames=(
            list(request_review_rows[0].keys())
            if request_review_rows
            else [
                "case_id",
                "abm",
                "request_kind",
