...
# Keep the existing import/test surface stable while delegating the progress
# contract logic to the extracted helper module.
_build_suite_progress = build_suite_progress
_refresh_progress_abm_snapshot = refresh_progress_abm_snapshot
    ...
    *,
    ...
    for abm, progress in progress_by_name.items():
        ...
        results[abm] = FullCaseSuiteAbmResult(
            ...
            success=True,
            run_root=run_root,
            report_json_path=progress.report_json_path or full_case_matrix_report_path(run_root),
            report_markdown_path=full_case_matrix_report_markdown_path(run_root),
            ...
            for abm in remaining_abms:
                ...
                try:
                    ...
                    abm_result = FullCaseSuiteAbmResult(
                        ...
                        report_json_path=full_case_matrix_report_path(abm_output_root),
                        report_markdown_path=full_case_matrix_report_markdown_path(abm_output_root),
