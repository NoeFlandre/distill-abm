...
def build_sample_case_payload(*, run_root: Path, report: JsonObject, case_dir: Path) -> JsonObject:
    ...
    return {
        ...
        "paths": {
            ...
            "trend_prompt_pre_compression": relative_path(run_root, inputs_dir / "trend_prompt_pre_compression.txt"),
            "trend_prompt_compressed": relative_path(run_root, inputs_dir / "trend_prompt_compressed.txt"),
            "trend_prompt_compression": relative_path(run_root, inputs_dir / "trend_prompt_compression.json"),
        ...
        "trend_prompt_pre_compression_text": read_optional_text(inputs_dir / "trend_prompt_pre_compression.txt"),
        "trend_prompt_compressed_text": read_optional_text(inputs_dir / "trend_prompt_compressed.txt"),
        "trend_prompt_compression_text": read_optional_text(inputs_dir / "trend_prompt_compression.json"),
        ...
        trend_entries.append(
            {
                ...
                "trend_prompt_pre_compression_path": relative_path(
                    run_root,
                    trend_dir / "trend_prompt_pre_compression.txt",
                ),
                "trend_prompt_pre_compression_text": read_optional_text(trend_dir / "trend_prompt_pre_compression.txt"),
                "trend_prompt_compressed_path": relative_path(run_root, trend_dir / "trend_prompt_compressed.txt"),
                "trend_prompt_compressed_text": read_optional_text(trend_dir / "trend_prompt_compressed.txt"),
                "trend_prompt_compression_path": relative_path(run_root, trend_dir / "trend_prompt_compression.json"),
                "trend_prompt_compression_text": read_optional_text(trend_dir / "trend_prompt_compression.json"),
